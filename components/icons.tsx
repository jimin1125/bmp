...
export const BeetleIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 12c0-5.18-4.32-9.42-9.75-9.42S0 6.82 0 12s4.32 9.42 9.75 9.42h4.5c2.61 0 4.75-2.01 4.75-4.5V12zM3 12h16.5M9.75 2.58v18.84" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 6.75l1.5 1.5m12-1.5l-1.5 1.5m-9 9l1.5-1.5m6 1.5l-1.5-1.5" />
    </svg>
);
...
export const CalendarDaysIcon: React.FC<{ className?: string }> = ({ className = "w-4 h-4" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const UsersIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.5-2.962c.566-.18 1.156-.341 1.768-.482a3.004 3.004 0 0 1 3.465 3.465c-.141.612-.302 1.202-.482 1.768m-6.32-1.32a3.004 3.004 0 0 1-2.074-2.074c.18-.566.341-1.156.482-1.768a3.004 3.004 0 0 1 3.465-3.465c.612.141 1.202.302 1.768.482M12 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    </svg>
);
